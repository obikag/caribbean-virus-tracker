            ...
            <StaticQuery
               ...
               render={data => (
                  <Helmet title={title || data.site.siteMetadata.defaultTitle} titleTemplate={data.site.siteMetadata.titleTemplate}>
                     ...
                     {data.site.siteMetadata.defaultTitle && <meta property="og:title" content={title || data.site.siteMetadata.defaultTitle} />}
                     ...
                     {data.site.siteMetadata.siteUrl && <link rel="canonical" href={url || data.site.siteMetadata.siteUrl} />}
                     <meta name="viewport" content="width=device-width, initial-scale=1" />
                     <link href="https://fonts.googleapis.com/css?family=Special+Elite|Montserrat" rel="stylesheet"></link>
